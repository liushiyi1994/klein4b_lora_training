...
from klein4b.marble_dataset import build_marble_v2_dataset  # noqa: E402
from klein4b.paths import data_dir  # noqa: E402


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Create marble-bust-data v2 with stone-carved hair captions."
    )
    parser.add_argument(
        "--source",
        type=Path,
    ...
    parser.add_argument(
        "--target",
        type=Path,
        default=data_dir() / "marble-bust-data" / "v2",
...
def main() -> None:
    ...
    report = build_marble_v2_dataset(args.source, args.target)
